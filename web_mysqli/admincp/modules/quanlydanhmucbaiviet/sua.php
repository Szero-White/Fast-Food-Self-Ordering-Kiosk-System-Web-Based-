...
<div class="content-card" style="background: linear-gradient(135deg, rgba(17,153,142,0.1) 0%, rgba(56,239,125,0.1) 100%); border: 1px solid rgba(17,153,142,0.2);">
    <div class="card-body-custom">
        <div class="d-flex align-items-center gap-3">
            ...
            <div>
                <h4 style="margin: 0; font-weight: 700; color: #333;">Sửa danh mục bài viết</h4>
            ...
            <div class="card-body-custom">
                <form method="POST" action="modules/quanlydanhmucbaiviet/xuly.php?idbaiviet=<?php echo $_GET['idbaiviet'] ?>">
                    ...
                    <div class="d-flex gap-3 mt-4">
                        <button type="submit" name="suadanhmucbaiviet" class="btn-custom btn-custom-primary" style="background: linear-gradient(135deg, #11998e 0%, #38ef7d 100%);">
